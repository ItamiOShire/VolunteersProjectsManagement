...
public interface VolunteerRepository extends JpaRepository<Volunteer, Long> {
   ...
   /* @Query("SELECT v FROM Volunteer v JOIN v.projects p WHERE v.id = :volunteerId AND p.id = :projectId")
    Volunteer findVolunteerByProjectIdAndVolunteerId(@Param("projectId")int projectId, @Param("volunteerId") int volunteerId);*/
